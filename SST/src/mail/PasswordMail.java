...
String username="skalpit048@gmail.com";//emailid
			String password="qwertyuiopalzm";//emailid password
String from="skalpit048@gmail.com";// email from which u have to send
